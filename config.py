...
"""The database URI that should be used for the connection. Examples: mysql+pymysql://username:password@host/database."""
...
DEBUG = True 
"""It enables/disables debug mode. If True, then debug mode is enabled while False means that debug mode is disabled. Make it False when deploying to production server."""